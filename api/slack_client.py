...
'''
	SLACK_TOKEN = 'XXX-XXX-XXX-XXX'
	Usage:
		client = SlackClient(SLACK_TOKEN)
		message="Hello Forecasters! This message was sent via slackAPI!"
		client.chat_post_message('#sage_crawlers', message, username='forecastscrawler')
'''
...
class SlackClient(object):
    ...
    BASE_SLACK_URL = 'https://slack.com/api'
    ...
    def _is_valid_channel_name(self, channel):
    ...
    def _make_request(self, method, params):
        ...
        url = "%s/%s" % (SlackClient.BASE_SLACK_URL, method)
    ...
    def chat_update_message(self, channel, text, timestamp, **params):
        ...
        """
        method = 'chat.update'
        if self._is_valid_channel_name(channel):
