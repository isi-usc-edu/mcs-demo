                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                <Paper component="div" className={classes.paper} square>
                                    ...
                                    <Input text={inputs.s2} disabled={inputs.s2.output != null} updateText={this.handleGetdata.bind(this)} />
                            ...
                            <Typography
                                ...
                                variant="h3"
                                className={classes.header}>
                                <h2 style={{color:"blue"}}>The predictions from previous users: input{this.state.inputs.preEvaluate}</h2>
